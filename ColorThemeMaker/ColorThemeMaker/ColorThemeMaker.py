...
from tkinter import BOTH, Variable, ttk
...
class App(tk.Tk):
    ...
    def StoreColor(self):
        ...
        self.stored_red = self.red_slider.get()
        self.stored_green = self.green_slider.get()
        self.stored_blue = self.blue_slider.get()

        #Create new widgets for the stored colors
        self.recall_button = tk.Button(self, text= "Recall Color", command= lambda:self.set_colors(self.stored_red, self.stored_green, self.stored_blue))
        self.new_color_tuple = tk.Label(self, text= "(" + red + "), " + "(" + green + "), " + "(" + blue + ")")
        self.new_color_hex = tk.Label(self, text= "#" + red_value + green_value + blue_value)
    ...
    def __init__(self):
        ...
        #Create the frames
        top_frame = tk.LabelFrame(self, padx= 5, pady= 5, bg= bg_color)
        bottom_frame = tk.Frame(self, padx= 5, pady= 5, bg= bg_color)
        ...
        self.red_slider = ttk.Scale(top_frame, from_= 0, to= 255, orient= 'vertical')#, command= Functions.HexRed(self, current_value))
